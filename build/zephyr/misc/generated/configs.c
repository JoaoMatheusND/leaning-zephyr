...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_GECKO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SILABS_SLEEPTIMER_TIMER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_PREEMPT_PRIORITIES, 15);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUILD_OUTPUT_HEX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_EMU, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_BT_HCI_EFR32_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_DBUS_PINCTRL_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_FLASH_CONTROLLER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_GPIO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_GPIO_PORT_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_I2C_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_IADC_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_STIMER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_TRNG_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_WAKE_UP_TRIGGER_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_WDOG_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_HFXO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_SERIES_CLOCK_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_SERIES2_DCDC_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_SERIES2_HFRCODPLL_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_SERIES2_LFRCO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_SERIES2_LFXO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_SERIES2_RADIO_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_SI7210_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_USART_SPI_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_USART_UART_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HAS_SILABS_SISDK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAIL_PA_CURVE_HEADER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAIL_PA_CURVE_TYPES_HEADER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RAIL_PA_ENABLE_CALIBRATION, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_SLTB010A, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_SLTB010A_EFR32BG22C224F512IM40, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_FAMILY_SILABS_S2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_EFR32BG22, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_EFR32BG22C224F512IM40, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_SDID, 205);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARM_SECURE_FIRMWARE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_CORE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_GPIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_PRS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_RTCC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_SE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_USART, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SILABS_SLEEPTIMER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_EMU_DCDC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_EMU_DCDC_MODE_ON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_DEV_INIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_CMU, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_HAS_RADIO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PREP_HOOK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_EARLY_INIT_HOOK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CLOCK_CONTROL_SILABS_SERIES, 1);
